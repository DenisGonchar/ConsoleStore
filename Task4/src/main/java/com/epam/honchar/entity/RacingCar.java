...
public class RacingCar extends Car {
    ...
    public RacingCar(double price, int guaranteePeriod, int amount, String name, int personPlaces, double maxSpeed, double clearance, double enginePower, double accelerationTime) {
